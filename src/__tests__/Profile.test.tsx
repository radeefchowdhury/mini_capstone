...
jest.mock("../app/api/supabase/supabase", () => ({
    ...
    from: jest.fn().mockReturnValue({
        select: jest.fn().mockResolvedValue({ data: [{} as UserProfileType], error: null }),
...
describe('Edit Profile Page', () => {
    ...
    it('renders profile information fields', () => {
    ...
    it('toggles visibility of registration key', async () => {
    ...
    // Add more tests as needed for interactions and validations
});
